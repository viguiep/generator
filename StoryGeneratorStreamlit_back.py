...
hero_gender
# FIN TODO
get_or_suggest_a_piece_of_information('hero_adj', 'An adjective to describe your hero (e.g. little, brave)',
                                      my_suggestions = MY_SUGGESTIONS['hero_adj'],
                                      my_value=my_values['hero_adj'])
get_or_suggest_a_piece_of_information('toy', "The hero's favourite cuddly toy (e.g. Mr Teddy)",
                                      my_suggestions = MY_SUGGESTIONS['toy'],
                                      my_value=my_values['toy'])


# VILLAIN (animals)
st.subheader("The villain")
get_or_suggest_a_piece_of_information('animal', 'A type of animal (e.g. bear, pig)',
                                      my_suggestions = MY_SUGGESTIONS['animal'],
                                      my_value=my_values['animal'])
# TODO
get_or_suggest_selectbox ('4', 'How many of the animals above will be in the story', my_suggestions=(1,2,3,4,5))
# FIN TODO
get_or_suggest_a_piece_of_information('animal_adj_not_size', "An adjective (not relating to size) describing the animal(s) (e.g. hairy, scary)",
                                      my_suggestions = MY_SUGGESTIONS['animal_adj_not_size'],
                                      my_value=my_values['animal_adj_not_size'])
...
# FIN TODO
get_or_suggest_a_piece_of_information('forest', 'The name of a forest or park nearby (e.g. Sherwood Forest)',
                                      my_suggestions = MY_SUGGESTIONS['forest'],
                                      my_value=my_values['forest'],)
get_or_suggest_a_piece_of_information('color', 'A colour (e.g. red, green)',
                                      my_suggestions = MY_SUGGESTIONS['color'],
                                      my_value=my_values['color'],)
get_or_suggest_a_piece_of_information('clothing', 'An item of clothing, singular (e.g. skirt, dungarees)',
                                      my_suggestions = MY_SUGGESTIONS['clothing'],
                                      my_value=my_values['clothing'],)
get_or_suggest_a_piece_of_information('healthy_food', 'A type of healthy vegetable, plural (e.g. carrots, cabbages)',
                                      my_suggestions = MY_SUGGESTIONS['healthy_food'],
                                      my_value=my_values['healthy_food'],)
"Five unhealthy foods, plural (e.g. biscuits, crisps)"
get_or_suggest_a_piece_of_information('unhealthy_food_1', 'Unhealthy food 1',
                                      my_suggestions = MY_SUGGESTIONS['unhealthy_food'],
                                      my_value=my_values['unhealthy_food_1'],)
get_or_suggest_a_piece_of_information('unhealthy_food_2', 'Unhealthy food 2',
                                      my_suggestions = MY_SUGGESTIONS['unhealthy_food'],
                                      my_value=my_values['unhealthy_food_2'],)
get_or_suggest_a_piece_of_information('unhealthy_food_3', 'Unhealthy food 3',
                                      my_suggestions = MY_SUGGESTIONS['unhealthy_food'],
                                      my_value=my_values['unhealthy_food_3'],)
get_or_suggest_a_piece_of_information('unhealthy_food_4', 'Unhealthy food 4',
                                      my_suggestions = MY_SUGGESTIONS['unhealthy_food'],
                                      my_value=my_values['unhealthy_food_4'],)
get_or_suggest_a_piece_of_information('unhealthy_food_5', 'Unhealthy food 5',
                                      my_suggestions = MY_SUGGESTIONS['unhealthy_food'],
                                      my_value=my_values['unhealthy_food_5'],)
